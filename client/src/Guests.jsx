...
class Guests extends React.Component {
  ...
  render() {
    return(
      <div className={styles.guests} ref={node => this.node = node}>
        <div className={styles.guestsHeader}>
          Guests
        </div>
        <div className={styles.guestsInputContainer}>
          <button className={styles.guestsInput} id={styles.guestsInput} onClick={this.toggleGuestsDropdown}>
            <div id={styles.guestButtonText}>
              {this.displayGuests()}
            </div>
            <svg className={styles.downwardPoint} width="40px" height="35px" display={this.state.closeGuestCarot}>
            ...
            <svg className={styles.upwardPoint} width="40px" height="35px" display={this.state.openGuestCarot}>
